...
export const CheckoutPage = () => {
    ...
    const finalize = async () => {
        ...
        try {
            ...
            navigate('/receptionist/check-out');
    ...
    return <Container size="lg" py="xl"><Stack gap="lg">
        <Group justify="space-between"><Group><Button variant="subtle" leftSection={<IconArrowLeft size={16}/>} onClick={() => navigate(-1)}>Back</Button><div><Title order={2}>Guest folio & Check-out</Title><Text c="dimmed">{summary.bookingCode}</Text></div></Group><Badge size="xl" color={summary.bookingStatus === 'CHECKED_OUT' ? 'green' : 'cyan'}>{summary.bookingStatus}</Badge></Group>
